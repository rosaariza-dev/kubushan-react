import CoworkingItem from "@/components/ui/CoworkingItem";
...
const Coworking = () => {
  return (
    <section
      id="coworking"
      className="bg-linear-to-l from-custom-gray-gradient to-white flex flex-col lg:flex-row flex-wrap"
    >
      ...
      <div className="py-14 px-8 flex-1 md:px-16">
        ...
        <span className="title">
          Zona Coworking: <br />
          Trabaja al siguiente nivel
        </span>
        <p className="description py-8">
          En Kubushan llevamos el café al siguiente nivel. <br />
          Nuestra zona coworking combina diseño moderno, tecnología de punta y
          el ambiente ideal para crear, trabajar y crecer.
        </p>
